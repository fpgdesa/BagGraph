...
public  class InBagAccumulator extends AccumulatorV2<Integer, Set<Integer>> implements Serializable 
	{
		private static final long serialVersionUID = -3739727823287550826L;

		private Set<Integer> _valueSource = new HashSet<Integer>();

		public InBagAccumulator() {
		}
		
		public InBagAccumulator(Integer value) {
